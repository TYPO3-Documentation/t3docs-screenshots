                ...
                'Styleguide' => [
                    'screenshots' => [
                        'actionsIdentifierScreenshots' => [
                            ...
                            ['action' => 'makeScreenshotOfElement', 'fileName' => "stylesheet_partially_scrolled_out_element", 'selector' => "#t3-table-tx_styleguide_elements_rte"],
                            ['action' => 'resizeWindow', 'width' => 1024, 'height' => 768],
                            ...
                            ['action' => 'makeScreenshotOfWindow', 'fileName' => "stylesheet_list_scrolled_to_element", "captionText" => "A caption text not linked"],
                            ['action' => 'makeScreenshotOfElement', 'fileName' => "stylesheet_tca_table", 'selector' => "#t3-table-pages_translated", "altText" => "This is a TCA table", "captionText" => "A caption text linked to my-reference", "captionReference" => "my-reference"],
