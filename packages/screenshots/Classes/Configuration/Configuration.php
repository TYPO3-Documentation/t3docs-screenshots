                ...
                'Styleguide' => [
                    'screenshots' => [
                        ...
                        'actionsIdentifierStyleguideScreenshots' => [
                            ...
                            ['action' => 'click', 'link' => "Backend Users"],
                            ['action' => 'switchToContentFrame'],
                            ['action' => 'click', 'link' => '//table//tr[1]//a[@data-dispatch-action="TYPO3.InfoWindow.showItem"]'],
                            ['action' => 'waitForModalDialogInMainFrame'],
                            ['action' => 'switchToModalDialogFrame'],
                            ['action' => 'scrollModalDialogFrameTo', 'toSelector' => 'table'],
                            ['action' => 'makeScreenshotOfWindow', 'fileName' => "ModalDialogFrameScrolledToElement"],
                            ['action' => 'switchToMainFrame'],
                            ['action' => 'closeModalDialog'],
                        ...
                        'actionsIdentifierStyleguideDraw' => [
                            ...
                            ['action' => 'click', 'link' => "(//*[contains(@class, \"t3js-editform-delete-record\")])[1]"],
                            ['action' => 'waitForModalDialogInMainFrame'],
                            ['action' => 'drawArrow', 'selector' => '.modal-footer button.btn-default', 'position' => 'left-middle'],
