                ...
                'Styleguide' => [
                    'screenshots' => [
                        'actionsIdentifierScreenshots' => [
                            ...
                            ['action' => 'makeScreenshotOfWindow', 'fileName' => "stylesheet_list_scrolled_to_element", "captionText" => "captionText without Link"],
                            ['action' => 'makeScreenshotOfElement', 'fileName' => "stylesheet_tca_table", 'selector' => "#t3-table-pages_translated", "altText" => "This is a TCA table", "captionText" => "A captionText with a reference", "captionReference" => "my-reference"],
