...
namespace TYPO3\Documentation\Screenshots\Runner\Codeception\SitePackage;
...
/**
 * Run all actions of TYPO3 environment "SitePackage"
 */
class SitePackageCest extends AbstractBaseCest
{
    /**
